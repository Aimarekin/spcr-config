...
import RevertButton, { RevertButtonProps } from "./configRowParts/RevertButton";
...
export type ConfigRowStandardFirstColumnProps = {
	...
	revertButtonCallback?: RevertButtonProps["onClick"];
};
...
export default function ConfigRowStandardFirstColumn(props: ConfigRowStandardFirstColumnProps) {
	...
	return (
		<div>
			{(props.title !== undefined || props.postTitle !== undefined) && (
				<ConfigRowTitle id={props.id} title={props.title} postTitle={props.postTitle} />
			)}
			{props.description !== undefined && (
				<ConfigRowDescription id={props.id}>{props.description}</ConfigRowDescription>
			)}
			{props.help !== undefined && <HelpTooltip label={props.help} />}
