...
import ConfigDisplayNumber, {
	ConfigDisplayNumberProps
} from "../../reactUtil/components/configDisplay/ConfigDisplayNumber";
...
export type ConfigFieldNumberDisplayProps = Required<
	Pick<ConfigDisplayNumberProps, "id" | "value" | "onChange" | "showRevertButton" | "revertButtonCallback">
>;
...
export default class ConfigFieldNumber extends ConfigField<number> {
	...
	readonly ReactFactory: (factoryProps: ConfigFieldNumberFactoryProps) => JSX.Element;
